...
Image Change_Saturation_manually(const Image &scr , double factor)     // Filter 19   Abdullah Youssef Abdullah 20240331
{
    Image dst = scr ;
    for (int i = 0; i < dst.width; i++)
    {
...
Image Change_Saturation_automatically(const Image &scr )     // Filter 19   Abdullah Youssef Abdullah 20240331
{
    Image dst = scr;
    double total_gray=0;
